...
~xdg-launcher-consult-source~ is a general-purpose ~consult--multi~ source and can be used in, e.g., [[https://github.com/armindarvish/consult-omni][consult-omni]] as well.
